...
dataset_name = 'breast_cancer_scale';%'fourclass'; %'murphy_synth'; %'breast_cancer_scale'; %'synth'; %'murphy_synth';
...
size(W)
size(X)
if dataset_name == 'breast_cancer_scale'
%if dataset_name == 'fourclass'
%if dataset_name == 'colon-cancer'
    X = X(1:end,7:8);
end
f=W*X'; 
